...
Welcome to the worlds first DeFi Python package with all major protocols intergrated into one package. With `DeFiPy <https://github.com/icmoore/defipy>`_, you can implement your analytics in one package. Since DeFiPy is built with a modular design in mind, you can implement the protocols separately using:
