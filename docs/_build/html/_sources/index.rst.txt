...
For DeFi event surveilance to help aid with `Onchain Analytics <tutorials/testnet_sim_univ2.html>`_, you can checkout `Web3Scout <https://github.com/defipy-devs/web3scout>`_. In terms of performing heavier analytics, when combined with Web3Scout, there is no other DeFi tool of its kind that has this type of capability and promise.
